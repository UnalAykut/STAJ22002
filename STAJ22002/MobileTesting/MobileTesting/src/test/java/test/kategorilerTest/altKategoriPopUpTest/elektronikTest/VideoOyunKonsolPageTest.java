...
public class VideoOyunKonsolPageTest extends AbstractBaseCategoryTest {

    @Test
    public void VideoOyunKonsolKategorilerTest() throws InterruptedException {
        performCategoryTest(KategorilerPage.Kategori.ELEKTRONIK,
                ElektronikKategorilerPage.class,
                ElektronikKategorilerPage.Kategori.VİDEO_OYUN_KONSOL,
